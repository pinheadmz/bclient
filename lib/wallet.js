...
class WalletClient extends Client {
  ...
  deriveReceive(id, account, index) {
    return this.post(`/wallet/${id}/derivereceive`, { account, index });
  }
  ...
  deriveChange(id, account, index) {
    return this.post(`/wallet/${id}/derivechange`, { account, index });
  }
  ...
  deriveNested(id, account, index) {
    return this.post(`/wallet/${id}/derivenested`, { account, index });
  }
...
class Wallet extends EventEmitter {
  ...
  deriveReceive(account, index ) {
    return this.client.deriveReceive(this.id, account, index);
  }
  ...
  deriveChange(account, index) {
    return this.client.deriveChange(this.id, account, index);
  }
  ...
  deriveNested(account, index) {
    return this.client.deriveNested(this.id, account, index);
  }
